export const MOVIES = [
  {
    ...
    runTime: "100 mins",
    synopsisTitle: "CAN YOU EVER REALLY TRUST ANYONE?",
    synopsis:
      "What a story! Everyone's favourite customer is back in a brand new adventure. Johnny is a successful banker with great respect and dedication to the people in his life, especially his future wife Lisa. The happy-go-lucky football tosser sees his world tearing him apart when everyone betrays him. And now he is fed up with this world!",
  },
  {
    ...
    runTime: "20 mins",
    synopsisTitle: "COOL CAT SAYS NO TO CORONA VIRUS AND YES TO HUGS WITH YOU",
    synopsis:
      "Cool Cat, fresh off of saving the kids, embarks on his most dangerous quest yet. The villainous Dirty Dog makes his debut as he plans to spread corona virus to all the kids in the world. Only Cool Cat has the strength and courage to stop him along with the world's only civilian owned Harrier Jet. Will Cool Cat be able to stop Dirty Dog in time?",
  },
  {
  ...
  },
  {
    ...
    director: "Jack Perez",
    runTime: "90 mins",
    synopsisTitle: "WINNER...EATS...ALL",
    synopsis:
      "A mega shark meets a giant octopus. They have an intense political debate over current government fiscal policy. It does not end well",
  },
  {
    ...
    releaseYear: "2021",
    director: "Simon Wesely, Joshua Wesely",
    runTime: "91 mins",
    synopsisTitle: "WOKE WAS THE REAL VIRUS ALL ALONG",
    synopsis:
      "In 2025, covid has achieved its ultimate goal, making christianity illegal. Its up to a ragtag group of podcasters and youtubers to save the day and make the world free once more.",
  },
  {
    code: "HotFrosty",
    title: "Hot Frosty",
    ...
    runTime: "90 mins",
    synopsisTitle: "DO YOU WANT TO LOVE A SNOWMAN?",
    synopsis:
      "When Frosty the Snowman was created from balls of snow, he was cold as ice. But when a wish turns him human, he is HOT. Watch as a desperate divorcee tries to take advantage of a newly sentient snowman with the body of an adult but the mind of a child",
  },
  {
    code: "Superfast!",
    title: "Superfast!",
    ...
    runTime: "99 mins",
    synopsisTitle: "KIND OF QUICK, SORT OF ANGRY",
    synopsis:
      "When you need to go furiously fast, but can't afford the hi cost of that other film franchise, you need the crew of Superfast! Ready to fulfill all of your speed needs while protected by copyright due to the USA's robust satire laws",
  },
  {
    ...
    runTime: "96 mins",
    synopsisTitle: "LIFE ON HAWAII IS EASY, AT LEAST UNTIL IT GETS HARD",
    synopsis:
      "Drugs have invaded the beautiful paradise of Hawaii. The only chance to get rid of them is with the powers of teamwork, love and kickboxing",
  },
  {
    code: "SamuraiCop",
    title: "Samurai Cop",
    ...
    runTime: "96 mins",
    synopsisTitle: "NO MORE MISTER NICE SAMURAI",
    synopsis:
      "When the Japanese Yakuza embeds itself deep into the LA criminal underworld, there is only one way to stop them. Sharper than a katana and quicker than a 9mm bullet, Joe Marshall is the samurai cop and the only one who can save LA",
  },
  {
    ...
    runTime: "78 mins",
    synopsisTitle: "IT CAME FROM THE STARS",
    synopsis:
      "The first 8 plans failed. But when the 9th planet arrives from outer space, will it be enough to save the day?",
  },
  {
    code: "HotBot",
    title: "Hot Bot",
    ...
    runTime: "86 mins",
    synopsisTitle: "THE BOT IS HOT EVEN WHEN YOU ARE NOT",
    synopsis: "",
  },
  {
    code: "Troll2",
    ...
    runTime: "95 min",
    synopsisTitle:
      "THEY'RE EATING HER. THEN THEY ARE GOING TO EAT ME. OH MY GOOOOOOOD",
    synopsis:
      "Get trolled once, shame on you. Get trolled twice, can't get trolled again",
  },
  {
    ...
    director: "Derek Savage",
    runTime: "75 mins",
    synopsisTitle: "COOL CAT LOVES YOU",
    synopsis:
      "The kids are in danger! Cool Cat, we need your help! Cool Cat leaps heroically into action to save the kids. And always remember, Cool Cat loves you",
  },
  {
    code: "PassThru",
    title: "Pass Thru",
    ...
    director: "Neil Breen",
    runTime: "90 mins",
    synopsisTitle: "JUST PASSING THRU",
    synopsis:
      "Neil Breen directs, stars, writes, produces, does his own stunts, casts, costumes and stars in a movie about just getting by in a world that doesn't want you to go",
  },
  {
    code: "Roar",
    title: "Roar",
    ...
    runTime: "95 mins",
    synopsisTitle: "ANIMALS DON'T SHOUT. THEY ROAR",
    synopsis:
      "A family's idyllic life operating an African animal refugee shatters when the animals go on a rampage. No animals were harmed in the making of this film. All humans were.",
  },
  {
    code: "NoHoldsBarred",
    ...
    runTime: "93 mins",
    synopsisTitle: "WHAT'S THAT SMELL? DOOKIE?",
    synopsis:
      "No holds are barred in this action extravaganza. Pure Hogan. Pure Americana. Pure Wrestling at its finest",
  },
  {
    ...
    runTime: "87 mins",
    synopsisTitle: "THE EXPENDABLES IF IT WAS GOOD",
    synopsis:
      "When an overbearing mom decides that the criminals need to give her cop son a day off. She is about to show the underworld some motherly love",
  },
  {
    code: "Megalopolis",
    title: "Megalopolis",
    ...
    runTime: "138 mins",
    synopsisTitle: "IF YOU BUILD IT THEY WILL COME",
    synopsis:
      "Ambition. Drive. Purpose. Bureaucracy. Do not let the world tell you what you can build. Build it. Ask for apology and permits after.",
  },
  {
    code: "MadameWeb",
    title: "Madame Web",
    ...
    runTime: "117 mins",
    synopsisTitle: "THE WEB OF FATE BINDS US ALL",
    synopsis:
      "That man is Ezekiel Simms. He was in the Amazon with my mom when she was researching spiders right before she died",
  },
];
